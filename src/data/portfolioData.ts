...
export const projects: Project[] = [
  {
    ...
    imageHint: 'AI-based online proctoring system',
  ...
  },
  {
    ...
    imageUrl: '/Bloom.jpg',
    imageHint: 'interactive plant care app UI',
  ...
  },
  {
    ...
    imageHint: 'Interactive Battleship game board interface',
  ...
  },
  {
    ...
    imageHint: 'exercise search interface with video tutorial suggestions',
    githubLink: 'https://github.com/uditbh1/goldsgymapp_udit',
    liveDemoLink: 'https://goldsgymviaudit.netlify.app/', // Replace with actual link
    tags: ['React'],
  },
  {
    id: 'jake-cv-builder',
    ...
    imageUrl: '/jakecv.jpg',
    imageHint: 'live preview of a modern resume builder',
  ...
  },
  {
    ...
    imageUrl: '/Etch.jpg',
    imageHint: 'etch-a-sketch style pixel grid UI',
    githubLink: 'https://github.com/uditbh1/Etch-a-Sketch', // update if needed
    liveDemoLink: 'https://uditbh1.github.io/Etch-a-Sketch/', // update if deployed
    tags: ['JavaScript'],
  },
  {
    id: 'spotify-clone',
    ...
    imageHint: 'Spotify clone music interface',
  ...
  },
  {
    ...
    imageHint: 'ecommerce product grid interface',
  ...
  
  {
    ...
    imageHint: 'Pokémon memory game interface',
  ...
  },
  {
    ...
    imageUrl: '/todo.jpg',
    imageHint: 'todo list user interface',
    githubLink: 'https://uditbh1.github.io/todolist/',
    liveDemoLink: 'https://github.com/uditbh1/todolist',
    tags: ['JavaScript']
  },
  {
    id: 'kalkulator',
    ...
    imageHint: 'calculator app interface resembling Windows 10 style',
    githubLink: 'https://github.com/uditbh1/kalkulator', // Update if needed
    liveDemoLink: 'https://uditbh1.github.io/kalkulator/',       // Replace with actual demo link if hosted
    tags: ['JavaScript'],
  },
  
  {
    ...
    imageHint: 'rock paper scissors buttons and result display',
  ...
  
  {
    ...
    imageHint: 'weather forecast UI with temperature and icons',
  ...
  },
  {
    ...
    imageHint: 'drum kit interface with clickable buttons',
  ...
  },
  {
    ...
    imageHint: 'Simon game UI with coloured buttons',
